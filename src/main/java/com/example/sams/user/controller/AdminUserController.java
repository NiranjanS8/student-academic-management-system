...
public class AdminUserController {
    ...
    @GetMapping("/teachers")
    public ApiResponse<PageResponse<TeacherProfileResponse>> listTeachers(
        ...
        return ApiResponse.success(
                ...
                PageResponse.from(teacherAdministrationService.listTeachers(departmentId, query, pageable))
        );
    }
    ...
    public ApiResponse<PageResponse<StudentProfileResponse>> listStudents(
        ...
        return ApiResponse.success(
                ...
                PageResponse.from(studentAdministrationService.listStudents(departmentId, programId, sectionId, query, pageable))
        );
    }
